...
CREATE TABLE IF NOT EXISTS "bank_accounts" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "organization_name" text NOT NULL, "balance_cents" integer NOT NULL, "iban" text NOT NULL, "bic" text NOT NULL);
