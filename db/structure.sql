...
CREATE TABLE IF NOT EXISTS "transfers" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "counterparty_name" text DEFAULT NULL, "counterparty_iban" text DEFAULT NULL, "counterparty_bic" text DEFAULT NULL, "amount_cents" integer DEFAULT NULL, "bank_account_id" integer NOT NULL, "description" text DEFAULT NULL, CONSTRAINT "fk_rails_09d60ae02b"
